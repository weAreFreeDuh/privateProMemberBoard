            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">게시글 작성</h5>
                    <p class="text-center small">게시글을 작성하시오</p>
                  </div>

                  <form action="bWrite" method="post"
										enctype="multipart/form-data" class="row g-3 needs-validation"
										novalidate>
										<input type="hidden" name="boWriter" value="${memInfo.memId}"/>

										<div class="col-12">
											<label for="yourName" class="form-label">게시글 제목</label> <input
												type="text" name="boTitle" class="form-control" 
												required>
										...
										<div class="col-12">
											...
											<textarea class="form-control" style="height: 400px" name="boContent" required></textarea>
